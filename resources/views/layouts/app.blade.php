...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <!-- Desktop Header -->
        <header class="w-full items-center py-2 px-6 hidden sm:flex bg-gradient-to-r from-yellow-900 via-green-500 to--100">
            <div class="w-1/2"></div>
    ...
    @else
    <aside class="relative bg-gradient-to-r from-yellow-500 via-red 500 to-black-100 h-screen w-64 hidden sm:block shadow-xl float-right">
        {{-- <div class="p-6">
        ...
        <div class="">
            <img src="logojaya.png" alt="" class="w-80 h-40 p-3">
        </div>
